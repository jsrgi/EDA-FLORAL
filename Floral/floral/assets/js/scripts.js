...
function _topNav() {
    ...
    if (jQuery("#topMain a.dropdown-toggle").bind("click", function (e) {
            ...
            jQuery("a", this).hasClass("external") || (e.preventDefault(), jQuery("#page-menu ul.menu-scrollTo>li").removeClass("active"), jQuery(this).addClass("active"), jQuery(t).length > 0 && (_padding_top = 0, jQuery("#header").hasClass("sticky") && (_padding_top = jQuery(t).css("padding-top"), _padding_top = _padding_top.replace("px", "")), jQuery("html,body").animate({scrollTop: jQuery(t).offset().top - _padding_top}, 800, "easeInOutExpo")))
                ...
                window.homeHeight = jQuery(window).outerHeight()
                    ...
                    if (window.width > 768) {
                        ...
                        _topBar_H = jQuery("#topBar").outerHeight() || 0, e > _topBar_H ? (a.addClass("fixed"), _header_H = a.outerHeight() || 0, a.hasClass("transparent") || a.hasClass("translucent") || jQuery("body").css({"padding-top": _header_H + "px"})) : (a.hasClass("transparent") || a.hasClass("translucent") || jQuery("body").css({"padding-top": "0px"}), a.removeClass("fixed"))
                    }
    ...
    if (jQuery("#sidebar_vertical_btn").length > 0 && jQuery("body").hasClass("menu-vertical-hide")) {
        if (_paddingStatusL = jQuery("#mainMenu.sidebar-vertical").css("left"), _paddingStatusR = jQuery("#mainMenu.sidebar-vertical").css("right"), parseInt(_paddingStatusL) < 0)var n = "left"; else if (parseInt(_paddingStatusR) < 0)var n = "right"; else var n = "left";
        jQuery("#sidebar_vertical_btn").bind("click", function (e) {
            _paddingStatus = jQuery("#mainMenu.sidebar-vertical").css(n), parseInt(_paddingStatus) < 0 ? "right" == n ? jQuery("#mainMenu.sidebar-vertical").stop().animate({right: "0px"}, 200) : jQuery("#mainMenu.sidebar-vertical").stop().animate({left: "0px"}, 200) : "right" == n ? jQuery("#mainMenu.sidebar-vertical").stop().animate({right: "-263px"}, 200) : jQuery("#mainMenu.sidebar-vertical").stop().animate({left: "-263px"}, 200)
        }), jQuery(window).scroll(function () {
            _paddingStatus = parseInt(jQuery("#mainMenu.sidebar-vertical").css(n)), _paddingStatus >= 0 && ("right" == n ? jQuery("#mainMenu.sidebar-vertical").stop().animate({right: "-263px"}, 200) : jQuery("#mainMenu.sidebar-vertical").stop().animate({left: "-263px"}, 200))
        })
    }
...
function _animate() {
    if (jQuery("body").hasClass("enable-animation")) {
        var e = new WOW({boxClass: "wow", animateClass: "animated", offset: 90, mobile: !1, live: !0});
        e.init()
    }
    jQuery(".countTo").appear(function () {
        var e = jQuery(this), t = e.attr("data-from") || 0, a = e.attr("data-speed") || 1300, r = e.attr("data-refreshInterval") || 60;
        e.countTo({from: parseInt(t), to: e.html(), speed: parseInt(a), refreshInterval: parseInt(r)})
    })
}
    ...
    _container.length > 0 && loadScript(plugin_path + "owl-carousel/owl.carousel.min.js", function () {
        _container.each(function () {
            ...
            function buildProgressBar() {
                $progressBar = jQuery("<div>", {id: "progressBar"}), $bar = jQuery("<div>", {id: "bar"}), $progressBar.append($bar).prependTo($elem)
            }
            ...
            function interval() {
                isPause === !1 && (percentTime += 1 / time, $bar.css({width: percentTime + "%"}), percentTime >= 100 && $elem.trigger("owl.next"))
            }
            ...
            var slider = jQuery(this), options = slider.attr("data-plugin-options"), $opt = eval("(" + options + ")");
...
function _flexslider() {
    ...
    e.length > 0 && loadScript(plugin_path + "slider.flexslider/jquery.flexslider-min.js", function () {
        if (jQuery().flexslider) {
            var t = e.attr("data-controlNav"), a = e.attr("data-slideshowSpeed") || 7e3, r = e.attr("data-pauseOnHover") || !1;
...
function _lightbox() {
    ...
    e.length > 0 && loadScript(plugin_path + "magnific-popup/jquery.magnific-popup.min.js", function () {
        return "undefined" == typeof jQuery.magnificPopup ? !1 : (jQuery.extend(!0, jQuery.magnificPopup.defaults, {
                ...
                var e = jQuery(this), t = e.attr("data-plugin-options"), a = {}, r = {
                    type: "image",
                    fixedContentPos: !1,
                    fixedBgPos: !1,
...
function _scrollTo(e, t) {
    0 == e ? (jQuery("a.scrollTo").bind("click", function (e) {
            e.preventDefault();
            var t = jQuery(this).attr("href"), a = jQuery(this).attr("data-offset") || 0;
            "#" != t && "#top" != t && jQuery("html,body").animate({scrollTop: jQuery(t).offset().top - parseInt(a)}, 800, "easeInOutExpo"), "#top" == t && jQuery("html,body").animate({scrollTop: 0}, 800, "easeInOutExpo")
        }), jQuery("#toTop").bind("click", function (e) {
            e.preventDefault(), jQuery("html,body").animate({scrollTop: 0}, 800, "easeInOutExpo")
        })) : jQuery("html,body").animate({scrollTop: jQuery(e).offset().top - t}, 800, "easeInOutExpo")
}
function _parallax() {
...
function _toggle() {
    ...
    jQuery("div.toggle.active > p").addClass("preview-active"), jQuery("div.toggle.active > div.toggle-content").slideDown(400), jQuery("div.toggle > label").click(function (t) {
        var a = jQuery(this).parent(), r = jQuery(this).parents("div.toggle"), i = !1, n = r.hasClass("toggle-accordion");
        if (n && "undefined" != typeof t.originalEvent && r.find("div.toggle.active > label").trigger("click"), a.toggleClass("active"), a.find("> p").get(0)) {
            i = a.find("> p");
            var o = i.css("height"), s = i.css("height");
            i.css("height", "auto"), i.css("height", o)
        }
        var l = a.find("> div.toggle-content");
        a.hasClass("active") ? (jQuery(i).animate({height: s}, 350, function () {
                jQuery(this).addClass("preview-active")
            }), l.slideDown(350)) : (jQuery(i).animate({height: e}, 350, function () {
...
function _wrotate() {
    jQuery(".word-rotator").each(function () {
        var e = jQuery(this), t = e.find(".items"), a = t.find("> span"), r = a.eq(0), i = r.clone(), n = jQuery(this).height(), o = 1, s = 0, l = jQuery(this).attr("data-delay") || 2e3;
        t.append(i), e.height(n).addClass("active"), setInterval(function () {
            s = o * n, t.animate({top: -s + "px"}, 300, "easeOutQuad", function () {
    ...
    e.length > 0 && loadScript(plugin_path + "text-rotator/jquery.simple-text-rotator.min.js", function () {
        e.each(function () {
            var e = jQuery(this), t = e.attr("data-animation") || "fade", a = e.attr("data-speed") || 2e3;
            e.textrotator({animation: t, speed: parseInt(a)})
        })
    })
}
function _lazyload() {
    ...
    e.length > 0 && loadScript(plugin_path + "lazyload/jquery.lazyload.min.js", function () {
        jQuery().lazyload && e.each(function () {
            var e = jQuery(this), t = e.attr("data-effect") || "fadeIn";
            e.lazyload({effect: t})
        })
    })
}
function _misc() {
    ...
    e.length > 0 && loadScript(plugin_path + "isotope/isotope.pkgd.min.js", function () {
        function e() {
            _dw = jQuery(document).width(), t.hasClass("fullwidth") ? (_w = t.width(), _wItem = _w / _cols, _dw < 760 && (_wItem = _w / 2), _dw < 480 && (_wItem = jQuery("#portfolio").width()), jQuery("#portfolio>.portfolio-item").css({width: _wItem})) : (_mR = parseInt(jQuery("#portfolio>.portfolio-item").css("margin-right")), _w = jQuery("#portfolio").closest(".container").width(), _wItem = _w / _cols - _mR, _dw < 760 && (_wItem = _w / 2 - _mR), _dw < 480 && (_wItem = _w), jQuery("#portfolio.portfolio-isotope").css({width: _w}), jQuery("#portfolio>.portfolio-item").css({width: _wItem})), jQuery(".flexslider").length > 0 && jQuery(".flexslider").resize()
        }
            ...
            t.hasClass("portfolio-isotope-2") ? _cols = 2 : t.hasClass("portfolio-isotope-3") ? _cols = 3 : t.hasClass("portfolio-isotope-4") ? _cols = 4 : t.hasClass("portfolio-isotope-5") ? _cols = 5 : t.hasClass("portfolio-isotope-6") ? _cols = 6 : _cols = 4, e(), jQuery(window).load(function () {
                setTimeout(function () {
                    t.isotope({
                        ...
                        t.isotope({filter: a, animationOptions: {duration: 750, easing: "linear", queue: !1}})
                    })
                }, 50);
                setTimeout(function () {
                    t.isotope("layout")
    ...
    if (t.length > 0 && loadScript(plugin_path + "isotope/isotope.pkgd.min.js", function () {
            function e() {
                _dw = jQuery(document).width(), t.hasClass("fullwidth") ? (_w = jQuery(document).width(), _wItem = _w / _cols, _dw < 760 && (_wItem = _w / 2), _dw < 480 && (_wItem = jQuery("#blog").width()), jQuery("#blog>.blog-post-item").css({width: _wItem})) : (_mR = parseInt(jQuery("#blog>.blog-post-item").css("margin-right")), _w = jQuery("#blog").closest(".container").width(), _wItem = _w / _cols - _mR, _dw < 760 && (_wItem = _w / 2 - _mR), _dw < 480 && (_wItem = _w), jQuery("#blog.blog-isotope").css({width: _w}), jQuery("#blog>.blog-post-item").css({width: _wItem})), jQuery(".flexslider").length > 0 && jQuery(".flexslider").resize()
            }
        ...
        _h = a.height() / 2, a.css({"margin-top": "-" + _h + "px"})
    }
    jQuery(".incr").bind("click", function (e) {
        e.preventDefault();
        var t = jQuery(this).attr("data-for"), a = parseInt(jQuery(this).attr("data-max")), r = parseInt(jQuery("#" + t).val());
        a > r && jQuery("#" + t).val(r + 1)
    }), jQuery(".decr").bind("click", function (e) {
        e.preventDefault();
        var t = jQuery(this).attr("data-for"), a = parseInt(jQuery(this).attr("data-min")), r = parseInt(jQuery("#" + t).val());
    ...
    r.length > 0 && loadScript(plugin_path + "custom.fle_upload.js"), jQuery("textarea.word-count").on("keyup", function () {
        var e = jQuery(this), t = this.value.match(/\S+/g).length, a = e.attr("data-maxlength") || 200;
        if (t > parseInt(a)) {
...
function _stickyFooter() {
    function e() {
        t = r.height(), a = jQuery(window).scrollTop() + jQuery(window).height() - t + "px", jQuery(document.body).height() + t > jQuery(window).height() ? r.css({position: "absolute"}).stop().animate({top: a}, 0) : r.css({position: "static"})
    }

    if (jQuery("#footer").hasClass("sticky")) {
        var t = 0, a = 0, r = jQuery("#footer.sticky");
        e(), jQuery(window).scroll(e).resize(e)
    }
}
function _countDown() {
    var e = jQuery(".countdown"), t = jQuery(".countdown-download");
    (e.length > 0 || t.length > 0) && loadScript(plugin_path + "countdown/jquery.countdown.pack.min.js", function () {
        e.each(function () {
            var e = jQuery(this), t = e.attr("data-from"), a = e.attr("data-labels");
            if (a && (a = a.split(",")), t) {
                var r = new Date(t);
            ...
            e.preventDefault();
            var t = jQuery(this), a = t.attr("data-for"), r = jQuery("#" + a + " span.download-wait>.countdown"), i = parseInt(t.attr("data-seconds")), n = t.attr("href");
...
function _masonryGallery() {
    jQuery(".masonry-gallery").length > 0 && jQuery(".masonry-gallery").each(function () {
        ...
        var a = e.find("a:eq(0)").outerWidth(), r = e.attr("data-img-big"), i = e.width(), n = i / t;
        n = Math.floor(n), n * t >= i && e.css({"margin-right": "-1px"}), 6 > t && e.children("a").css({width: n + "px"}), parseInt(r) > 0 && (r = Number(r) - 1, e.find("a:eq(" + r + ")").css({width: 2 * a + "px"}), loadScript(plugin_path + "isotope/isotope.pkgd.min.js", function () {
            setTimeout(function () {
                e.isotope({masonry: {columnWidth: a}}), e.isotope("layout")
            }, 1e3)
        }))
    })
}
...
function _form() {
    jQuery("form.validate-plugin").length > 0 && loadScript(plugin_path + "form.validate/jquery.form.min.js", function () {
        ...
        loadScript(plugin_path + "form.validate/jquery.validation.min.js", function () {
            jQuery().validate && jQuery("form.validate").each(function () {
                var e = jQuery(this), t = e.attr("data-success") || "Successfully! Thank you!", a = (e.attr("data-captcha") || "Invalid Captcha!", e.attr("data-toastr-position") || "top-right"), r = e.attr("data-toastr-type") || "success";
    ...
    e.length > 0 && loadScript(plugin_path + "form.masked/jquery.maskedinput.js", function () {
        e.each(function () {
            var e = jQuery(this);
            _format = e.attr("data-format") || "(999) 999-999999", _placeholder = e.attr("data-placeholder") || "X", jQuery.mask.definitions.f = "[A-Fa-f0-9]", e.mask(_format, {placeholder: _placeholder})
        })
    })
}
function _pickers() {
    ...
    t.length > 0 && loadScript(plugin_path + "bootstrap.daterangepicker/moment.min.js", function () {
        loadScript(plugin_path + "bootstrap.daterangepicker/daterangepicker.js", function () {
            jQuery().datepicker && t.each(function () {
                var e = jQuery(this), t = e.attr("data-format").toUpperCase() || "YYYY-MM-DD";
                e.daterangepicker({
                    format: t,
    ...
    r.length > 0 && loadScript(plugin_path + "spectrum/spectrum.min.js", function () {
        jQuery().spectrum && r.each(function () {
            var e = jQuery(this), t = e.attr("data-format") || "hex", a = e.attr("data-palletteOnly") || "false", r = e.attr("data-fullpicker") || "false", i = e.attr("data-allowEmpty") || !1;
...
function _pajinate() {
    ...
    e.length > 0 && loadScript(plugin_path + "pajinate/jquery.pajinate.bootstrap.min.js", function () {
        jQuery().pajinate && e.each(function () {
            var e = jQuery(this), t = e.attr("data-pajinante-items-per-page") || 8;
...
function _zoom() {
    ...
    e.length > 0 && loadScript(plugin_path + "image.zoom/jquery.zoom.min.js", function () {
        jQuery().zoom && e.each(function () {
            var e = jQuery(this), t = e.attr("data-mode"), a = e.attr("id");
            "grab" == t ? e.zoom({on: "grab"}) : "click" == t ? e.zoom({on: "click"}) : "toggle" == t ? e.zoom({on: "toggle"}) : e.zoom(), a && jQuery(".zoom-more[data-for=" + a + "] a").bind("click", function (e) {
                e.preventDefault();
                var t = jQuery(this).attr("href");
...
function _stepper() {
    ...
    e.length > 0 && loadScript(plugin_path + "form.stepper/jquery.stepper.min.js", function () {
        jQuery().stepper && jQuery(e).each(function () {
            var e = jQuery(this), t = e.attr("min") || null, a = e.attr("max") || null;
            e.stepper({
                limit: [t, a],
...
function _modalAutoLoad() {
    jQuery("div.modal").length > 0 && jQuery("div.modal").each(function () {
        var e = jQuery(this), t = e.attr("id"), a = e.attr("data-autoload") || !1;
...
function _widget_flickr() {
    ...
    e.length > 0 && loadScript(plugin_path + "widget.jflickr/jflickrfeed.min.js", function () {
        jQuery().jflickrfeed && jQuery(".widget-flickr") && e.each(function () {
            var e = jQuery(this), t = e.attr("data-id"), a = e.attr("data-limit") || 14;
            e.jflickrfeed({
                limit: parseInt(a),
                qstrings: {id: t},
...
function _widget_twitter() {
    ...
    e.length > 0 && loadScript(plugin_path + "widget.twittie/twittie.min.js", function () {
        jQuery().twittie && e.each(function () {
            var e = jQuery(this), t = e.attr("data-php"), a = e.attr("data-username"), r = e.attr("data-limit") || 3, i = t + "?username=" + a + "&limit=" + r;
...
function format_twitter(e) {
    for (var t = [], a = 0; a < e.length; a++) {
        var r = e[a].user.screen_name, i = e[a].text.replace(/((https?|s?ftp|ssh)\:\/\/[^"\s\<\>]*[^.,;'">\:\s\<\>\)\]\!])/g, function (e) {
...
function relative_time(e) {
    var t = e.split(" "), a = Date.parse(e), r = arguments.length > 1 ? arguments[1] : new Date, i = parseInt((r.getTime() - a) / 1e3);
...
function _widget_facebook() {
    var e = jQuery("div.fb-like"), t = jQuery("div.fb-share-button");
...
function _widget_dribbble() {
    ...
    e.length > 0 && loadScript(plugin_path + "widget.dribbble/jribbble.min.js", function () {
        var t = e.attr("data-token") || "f688ac519289f19ce5cebc1383c15ad5c02bd58205cd83c86cbb0ce09170c1b4", a = e.attr("data-target") || "_blank", r = e.attr("data-shots") || 2046896;
...
var _arr = {};
/pofweb/.test(self.location.href) || /tstrap/.test(self.location.href), function (e) {
    function t(e, t) {
    ...
    e.fn.countTo = function (t) {
        return t = t || {}, jQuery(this).each(function () {
            ...
            }, t), n = Math.ceil(i.speed / i.refreshInterval), o = (i.to - i.from) / n, s = this, l = jQuery(this), u = 0, c = i.from, d = l.data("countTo") || {};
    ...
    e.fn.appear = function (t, a) {
        var r = e.extend({data: void 0, one: !0, accX: 0, accY: 0}, a);
        return this.each(function () {
            var a = e(this);
            if (a.appeared = !1, !t)return void a.trigger("appear", r.data);
            var i = e(window), n = function () {
                if (!a.is(":visible"))return void(a.appeared = !1);
                var e = i.scrollLeft(), t = i.scrollTop(), n = a.offset(), o = n.left, s = n.top, l = r.accX, u = r.accY, c = a.height(), d = i.height(), p = a.width(), h = i.width();
    ...
    t.resize(function () {
        ...
        function o() {
            ...
            var o = t.scrollTop();
            u.each(function () {
                var t = e(this), n = t.offset().top, c = s(t);
    ...
    t = function () {
        ...
        return i.prototype.defaults = {
            ...
            if (this.stopped = !1, this.boxes = function () {
                    ...
                    return i
                }.call(this), this.boxes.length)if (this.disabled()) this.resetStyle(); else for (i = this.boxes, a = 0, r = i.length; r > a; a++)t = i[a], this.applyStyle(t, !0);
            ...
            return t && this.cacheAnimationName(e), e.style.visibility = t ? "hidden" : "visible", a && this.vendorSet(e.style, {animationDuration: a}), r && this.vendorSet(e.style, {animationDelay: r}), i && this.vendorSet(e.style, {animationIterationCount: i}), this.vendorSet(e.style, {animationName: t ? "none" : this.cachedAnimationName(e)}), e
    ...
    function l(e, t, a) {
        var r = e.charAt(0).toUpperCase() + e.slice(1), n = (e + " " + w.join(r + " ") + r).split(" ");
        return i(t, "string") || i(t, "undefined") ? o(n, t) : (n = (e + " " + b.join(r + " ") + r).split(" "), s(n, t, a))
    }

    var u, c, d, p = "2.7.1", h = {}, f = !0, y = t.documentElement, m = "modernizr", g = t.createElement(m), v = g.style, j = ({}.toString, " -webkit- -moz- -o- -ms- ".split(" ")), Q = "Webkit Moz O ms", w = Q.split(" "), b = Q.toLowerCase().split(" "), _ = {}, A = [], C = A.slice, x = function (e, a, r, i) {
        var n, o, s, l, u = t.createElement("div"), c = t.body, d = c || t.createElement("body");
    ...
    d = i(S, "undefined") || i(S.call, "undefined") ? function (e, t) {
        ...
        var a = C.call(arguments, 1), r = function () {
            if (this instanceof r) {
                var i = function () {
                };
                i.prototype = t.prototype;
                var n = new i, o = t.apply(n, a.concat(C.call(arguments)));
        ...
        var e = t.createElement("video"), a = !1;
        try {
    ...
    return h.addTest = function (e, t) {
        if ("object" == typeof e)for (var r in e)d(e, r) && h.addTest(r, e[r]); else {
        ...
        function a(e, t) {
            var a = e.createElement("p"), r = e.getElementsByTagName("head")[0] || e.documentElement;
        ...
        var u, c, d = "3.7.0", p = e.html5 || {}, h = /^<|^(?:button|map|select|textarea|object|iframe|option|optgroup)$/i, f = /^(?:a|b|code|div|fieldset|h1|h2|h3|h4|h5|h6|i|label|li|ol|p|q|span|strong|style|table|tbody|td|th|tr|ul)$/i, y = "_html5shiv", m = 0, g = {};
        !function () {
            try {
    ...
    function l(e, a, r, i, n, l, u) {
        ...
        var u = u || p.errorTimeout, d = t.createElement(e), h = 0, m = 0, j = {t: r, s: a, e: n, a: l, x: u};
    ...
    var d, p, h = t.documentElement, f = e.setTimeout, y = t.getElementsByTagName("script")[0], m = {}.toString, g = [], v = 0, j = "MozAppearance" in h.style, Q = j && !!t.createRange().compareNode, w = Q ? h : y.parentNode, h = e.opera && "[object Opera]" == m.call(e.opera), h = !!t.attachEvent && !h, b = j ? "object" : h ? "script" : "img", _ = h ? "script" : b, A = Array.isArray || function (e) {
    ...
    p = function (e) {
        function t(e) {
            var t, a, r, e = e.split("!"), i = C.length, n = e.pop(), o = e.length, n = {
                url: n,
                origUrl: n,
                prefixes: e
            };
        ...
        function s(e, t) {
            function a(e, a) {
                if (e) {
                    if (i(e)) a || (d = function () {
                        ...
                        p.apply(this, e), h()
                    }), o(e, d, t, 0, u); else if (Object(e) === e)for (l in s = function () {
                        var t, a = 0;
            ...
            var s, l, u = !!e.test, c = e.load || e.both, d = e.callback || n, p = d, h = e.complete || n;
            a(u ? e.yep : e.nope, !!c), c && a(c)
        }

        var l, u, d = this.yepnope.loader;
        if (i(e)) o(e, 0, d, 0); else if (A(e))for (l = 0; l < e.length; l++)u = e[l], i(u) ? o(u, 0, d, 0) : A(u) ? p(u) : Object(u) === u && s(u, d); else Object(e) === e && s(e, d)
        ...
        var c, d, h = t.createElement("script"), i = i || p.errorTimeout;
        h.src = e;
        ...
        var u, i = t.createElement("link"), a = l ? s : a || n;
